$(document).ready(function () {
    ...
    $('.navbar-toggle').click(function (e) {
        ...
        $('.sidebar-nav').toggleClass('activer');
    ...
    $('a.ajax-link').click(function (e) {
        if (msie) e.which = 1;
        if (e.which != 1 || !$('#is-ajax').prop('checked') || $(this).parent().hasClass('activer')) return;
        e.preventDefault();
        $('.sidebar-nav').removeClass('activer');
        $('.navbar-toggle').removeClass('activer');
        $('#loading').remove();
        $('#content').fadeOut().parent().append('<div id="loading" class="center">Loading...<div class="center"></div></div>');
        var $clink = $(this);
        History.pushState(null, null, $clink.attr('href'));
        $('ul.main-menu li.active').removeClass('activer');
        $clink.parent('li').addClass('activer');
    });
    ...
    $('.accordion > a').click(function (e) {
        ...
        var $li = $(this).parent();
        if ($ul.is(':visible')) $li.removeClass('activer');
        else                    $li.addClass('activer');
        $ul.slideToggle();
    });
